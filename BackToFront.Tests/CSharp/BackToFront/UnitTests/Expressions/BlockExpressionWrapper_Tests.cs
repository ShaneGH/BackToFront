...
{
    [TestFixture]
    public class BlockExpressionWrapper_Tests : Base.TestBase
    {
        ...
        public class Accessor : BlockExpressionWrapper
        {
            public Accessor(BlockExpression expression)
                : base(expression)
            {
            }
        ...
        public void _GetMembersForParameter_Test()
        {
            ...
            var subject = new Accessor(Expression.Block(func1.Body, func2.Body, func3));
        ...
        public void IsSameExpression_Test(bool isSame)
        {
            ...
            Func<bool, BlockExpression> create = a => a ? Expression.Block(func1.Body, func2.Body, func3) : Expression.Block(func1.Body, func2.Body, Expression.Empty());
