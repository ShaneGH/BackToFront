...
{
    [TestFixture]
    public class ConditionalExpressionWrapper_Tests : Base.TestBase
    {
        ...
        public class Accessor : ConditionalExpressionWrapper
        {
            public Accessor(ConditionalExpression expression)
                : base(expression)
            {
            }
        ...
        public void _GetMembersForParameter_Test()
        {
            ...
            var subject = new Accessor(Expression.Condition(func1.Body, func2.Body, func3));
        ...
        public void IsSameExpression_Test(bool isSame)
        {
            ...
            Func<bool, ConditionalExpression> create = a => a ?
                Expression.Condition(func1.Body, func2.Body, func3) :
                Expression.Condition(func1.Body, func2.Body, Expression.Constant(true));
