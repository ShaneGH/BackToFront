...
..\..\BackToFront.Tests\bin\Debug\Chutzpah\chutzpah.console.exe /path "..\..\BackToFront.Tests\bin\Debug\Javascript\BackToFront" /testMode JavaScript /failOnScriptError /debug  /openInBrowser