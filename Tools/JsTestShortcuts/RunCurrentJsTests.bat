...
..\..\BackToFront.Tests\bin\Debug\Chutzpah\chutzpah.console.exe /path "..\..\BackToFront.Tests\bin\Debug\Javascript\UnitTests\CURRENT_TEST.js" /testMode JavaScript /failOnScriptError /wait